...
namespace ExampleMod.Content.Hairs
{
	...
	public class ExampleHair : ModHair
	{
		...
		// 请记住 that hairstyles can be used with any gender; this property just allows for defining behavior during randomization.
		// 如果 not set by us like here, Gender.Unspecified will be used instead, which randomizes the gender independent of the hairstyle.
