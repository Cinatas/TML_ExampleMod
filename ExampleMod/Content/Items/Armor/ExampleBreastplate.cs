...
namespace ExampleMod.Content.Items.Armor
{
	...
	// Providing the EquipType.Body value here will result in TML expecting X_Arms.png, X_Body.png and X_FemaleBody.png sprite-sheet files to be placed next 到 item's main texture.
	...
	public class ExampleBreastplate : ModItem
	{
		...
		public override void UpdateEquip(Player player) {
			player.buffImmune[BuffID.OnFire] = true; // 使 the player immune to Fire
