...
namespace ExampleMod.Content.Items.Ammo
{
	public class ExampleGravityDebuffBullet : ModItem
	{
		...
		public override void SetDefaults() {
			Item.damage = 1; // The 伤害 for projectiles isn't actually 1, it actually is the 伤害 combined 与 弹幕 and the 项 together.
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.ExampleGravityDebuffBullet>(); // The 弹幕 that weapons fire when using this 项 as ammunition.
