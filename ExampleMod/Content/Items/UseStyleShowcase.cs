...
{
	/// <summary>
	/// This item lets you test the existing ItemUseStyleID values for Item.useStyle. Note th在 sword texture might not fit each 的 useStyle animations.
	/// </summary>
	public class UseStyleShowcase : ModItem
	{
		...
		public override void SetDefaults() {
			...
			// 在 Visual Studio, you can click on "ItemUseStyleID" 然后 press F12 to see the list of possible values. You can also type "ItemUseStyleID." to view the list of possible values.
