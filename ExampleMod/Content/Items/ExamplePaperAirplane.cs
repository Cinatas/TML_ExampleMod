...
namespace ExampleMod.Content.Items
{
	public class ExamplePaperAirplane : ModItem
	{
		public override void SetDefaults() {
			...
			Item.value = Item.sellPrice(0, 0, 10); // The value 的 item. In this case, 10 silver. Item.buyPrice & Item.sellPrice are helper methods that returns costs in copper coins based on platinum/gold/silver/copper arguments provided to it.
