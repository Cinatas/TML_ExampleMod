...
namespace ExampleMod.Content.Items
{
	public class ExamplePaperAirplane : ModItem
	{
		public override void SetDefaults() {
			...
			Item.value = Item.sellPrice(0, 0, 10); // The 值 的 项. In this case, 10 银币. 项.buyPrice & 项.sellPrice are helper methods that returns costs in 铜币 coins 基于 铂金币/金币/银币/铜币 arguments provided to it.
