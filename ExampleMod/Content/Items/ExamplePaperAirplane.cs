...
namespace ExampleMod.Content.Items
{
	public class ExamplePaperAirplane : ModItem
	{
		public override void SetDefaults() {
			...
			Item.value = Item.sellPrice(0, 0, 10); // The 值 的 项. 在这种情况下, 10 银币. 项.buyPrice & 项.sellPrice are helper methods that returns costs in 铜币 coins 基于 铂金币/金币/银币/铜币 arguments provided to it.
			...
			// above 项.DefaultToThrownWeapon() does the following. Uncomment these if you don't 想要 use the above 方法 or 想要 change something about it.
			// 项.autoReuse = 假;
			...
			// above 项.SetWeaponValues() does the following. Uncomment these if you don't 想要 use the above 方法.
			// 项.伤害 = 4;
			// 项.knockBack = 2;
			// 项.crit = 0; // 尽管 this says 0, this is more like "奖励 critical strike 概率". All weapons have a base critical strike 概率 of 4.
		}
