...
namespace ExampleMod.Content.Items.Weapons
{
	public class ExampleJoustingLance : ModItem
	{
		public override void SetDefaults() {
			...
			// 要 see everything DefaultToSpear() does, 右 点击 the 方法 in Visual Studios and choose "Go To Definition" (or press F12). You can also 悬停 over DefaultToSpear to see the documentation.
			// shoot 速度 will affect how far away the 弹幕 spawns 从 玩家's hand.
			// 如果 you are using the custom AI in your 弹幕 (and not aiStyle 19 and AIType = ProjectileID.JoustingLance), the standard 值 is 1f.
			...
			Item.DamageType = DamageClass.MeleeNoSpeed; // We need to use MeleeNoSpeed here so that 攻击 速度 doesn't 效果 our held 弹幕.
			...
			// This will make sure our 弹幕 completely disappears on hurt.
		...
		// This will 允许 our Jousting Lance to receive the same modifiers as melee weapons.
