...
namespace ExampleMod.Content.Tiles
{
	...
	public class Example2x1RubbleNatural : Example2x1RubbleBase
	{
		public override void SetStaticDefaults() {
			...
			// 默认情况下, the TileObjectData.Style2x1 图格 we copied in Example2x1RubbleBase has LavaDeath = 真. Natural rubble tiles don't have this behavior, so we want to be immune to lava.
