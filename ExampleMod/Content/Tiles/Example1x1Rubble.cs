...
namespace ExampleMod.Content.Tiles
{
	...
	// 示例1x1RubbleBase is an abstract class, it is not an actual tile, but the other 2 classes in this file will reuse the Texture and SetStaticDefaults code shown here because they inherit from it. 
	...
	public class Example1x1RubbleNatural : Example1x1RubbleBase
	{
		public override void SetStaticDefaults() {
			...
			// 默认情况下, the TileObjectData.Style1x1 tile we copied in Example1x1RubbleBase has LavaDeath = true. Natural rubble tiles don't have this behavior, so we want to be immune to lava.
