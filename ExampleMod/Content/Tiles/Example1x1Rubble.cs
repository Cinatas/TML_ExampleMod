...
namespace ExampleMod.Content.Tiles
{
	...
	// 示例1x1RubbleBase is an abstract 类, it is not an actual 图格, but the other 2 classes in this 文件 will reuse the 纹理 and SetStaticDefaults code shown here because they inherit from it. 
	...
	public class Example1x1RubbleNatural : Example1x1RubbleBase
	{
		public override void SetStaticDefaults() {
			...
			// 默认情况下, the TileObjectData.Style1x1 图格 we copied in Example1x1RubbleBase has LavaDeath = 真. Natural rubble tiles don't have this behavior, so we want to be immune to lava.
