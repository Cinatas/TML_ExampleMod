...
namespace ExampleMod.Content.Tiles
{
	...
	public class Example1x1RubbleNatural : Example1x1RubbleBase
	{
		public override void SetStaticDefaults() {
			...
			// 默认情况下, the TileObjectData.Style1x1 图格 we copied in Example1x1RubbleBase has LavaDeath = 真. Natural rubble tiles don't have this behavior, so we 想要 be immune to lava.
