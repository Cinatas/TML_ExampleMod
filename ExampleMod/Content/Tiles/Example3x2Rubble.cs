...
namespace ExampleMod.Content.Tiles
{
	...
	public class Example3x2RubbleNatural : Example3x2RubbleBase
	{
		public override void SetStaticDefaults() {
			...
			// 默认情况下, the TileObjectData.Style3x2 图格 we copied in Example3x2RubbleBase has LavaDeath = 真. Natural rubble tiles don't have this behavior, so we 想要 be immune to lava.
