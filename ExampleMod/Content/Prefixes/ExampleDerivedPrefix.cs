namespace ExampleMod.Content.Prefixes
{
	...
	// 此类 showcases how you can use inheritance to have an easier time with making variants of a single prefix.
	...
	public class ExampleDerivedPrefix : ExamplePrefix // Deriving from ExamplePrefix!
	{
		...
		// 如果 you want to modify the base class' implementation's value, you can write 'base.Power' to reference it. 
		public override float Power => base.Power * 2f;

		// No need for anything else, since members get inherited 从 base class.
	}
}
