...
namespace ExampleMod.Content.Projectiles
{
	public class MinionBossEye : ModProjectile
	{
		...
		public override Color? GetAlpha(Color lightColor) {
			// 当 overriding GetAlpha, you usually want to take the projectiles alpha into account. As it is a value between 0 and 255,
		...
		public override void AI() {
			...
			// 如果 the sprite points upwards, this will make it point towards the move direction (for other sprite orientations, change MathHelper.PiOver2)
