...
namespace ExampleMod.Content.Projectiles
{
	public class ExampleGolfBallProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			ProjectileID.Sets.IsAGolfBall[Type] = true; // 允许s the projectile to be placed on the tee.
			ProjectileID.Sets.TrailingMode[Type] = 0; // 创建s a trail behind the golf ball.
			ProjectileID.Sets.TrailCacheLength[Type] = 20; // 设置s the length of the trail.
		}
