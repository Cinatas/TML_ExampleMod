...
namespace ExampleMod.Content.DamageClasses
{
	public class ExampleDamageClass : DamageClass
	{
		...
		public override bool GetEffectInheritance(DamageClass damageClass) {
			// 此方法 allows you to make your damage class benefit from and be able to activate other classes' effects (e.g. Spectre bolts, Magma Stone) based on what returns true.
			// 注意 that unlike our stat inheritance methods up above, you do not need to account for universal bonuses in this method.
			// 对于 this example, we'll make our class able to activate melee- and magic-specifically effects.
		...
		public override void SetDefaultStats(Player player) {
			// 此方法 lets you set default statistical modifiers for your example damage class.
		...
		// 注意 that setting it to false will also prevent the critical strike chance tooltip line from being shown.
