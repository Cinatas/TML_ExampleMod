...
namespace ExampleMod.Items
{
	public class BossBags : GlobalItem
	{
		public override void OpenVanillaBag(string context, Player player, int arg) {
			...
			// Typically you'll also want to also add an item 到 non-expert boss drops, that code 可以 found in ExampleGlobalNPC.NPCLoot. Use this and that to add drops to bosses.
