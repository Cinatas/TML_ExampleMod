...
namespace ExampleMod.Items
{
	internal class ExampleDrawTooltips : ModItem
	{
		...
		public override bool PreDrawTooltip(ReadOnlyCollection<TooltipLine> lines, ref int x, ref int y) {
			// You can 偏移 the entire 工具提示 by changing x and y
			// You can actually have the entire 工具提示 draw somewhere else, x and y is where the 工具提示 starts drawing
			...
			// We will 开始 drawing the box slightly 偏移 to accommodate for 填充
		...
		public override bool PreDrawTooltipLine(DrawableTooltipLine line, ref int yOffset) {
			if (!line.oneDropLogo) {
				...
				// This 可能 important, in case some mod does a lot of custom work and removes the standard 工具提示
				// For 工具提示 layers, check the documentation for TooltipLine
				{
					...
					// Note how our line 对象 has many properties we can use for drawing
					...
					// yOffset affects the 偏移 即 added every next line, so this will cause the line to come after the separator to be drawn slightly lower
