...
namespace ExampleMod.UI
{
	...
	// ItemSlot isn't very modder friendly and operates based on a "Context" 数字 that dictates how the 槽位 behaves when 左, 右, or shift clicked and the 背景 used when drawn. 
	// If you want more 控制, you might need to write your own UIElement.
