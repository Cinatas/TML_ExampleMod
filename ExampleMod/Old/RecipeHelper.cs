...
namespace ExampleMod
{
	...
	public static class RecipeHelper
	{
		...
		public static void AddExampleRecipes(Mod mod) {
			...
			// 检查 the 方法 签名 of MakeSimpleRecipes 对于 arguments, this is a 方法 签名:
		...
		private static void AddBossRecipes(Mod mod) {
			...
			// We are using the same helper 方法 here, and we are making use 的 reqTile 参数
			...
			// notice how we can 跳过 optional parameters by specifying the 目标 参数 with 'reqTile:', this means the resultStack will remain 1
